...
def main() -> None:
    ...
    parser.add_argument("--visualize-dir", type=Path, default=DetectionInferenceConfig.visualize_dir)
    ...
    with mlflow.start_run(run_name=run_name):
        ...
        if cfg.visualize:
            visualization_path = cfg.visualize_dir / f"{image_stem}_detections.png"
